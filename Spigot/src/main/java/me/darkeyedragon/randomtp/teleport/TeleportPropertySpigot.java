...
public class TeleportPropertySpigot implements TeleportProperty {
    ...
    public TeleportPropertySpigot(CommandIssuer commandIssuer, RandomLocation location, boolean bypassEco, boolean bypassTeleportDelay, boolean bypassCooldown, RandomParticle<Particle> particle) {
